...
def main() -> None:
    ...
    st.markdown('<div style="margin-top:1rem;padding:.65rem 0;border-top:1px solid var(--line);color:#60798d;font-size:14px">CPSE MATERIAL INTELLIGENCE · SIH 2026 · PS 26099 · Deterministic decision engine · Optional advisory AI layer</div>', unsafe_allow_html=True)
